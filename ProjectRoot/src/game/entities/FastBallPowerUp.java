...
public class FastBallPowerUp extends PowerUp {
    ...
    public String newBackGroundURL = "C:\\Users\\Admin\\IdeaProjects\\NhomFuHo2005\\ProjectRoot\\src\\assets\\images\\cool.jpg";
    ...
    public void upgradeBall() {
        if (havePower) {
            ...
            float speed = ball.getDefaultSpeed() * 1.25f; // ví dụ tăng 50%
